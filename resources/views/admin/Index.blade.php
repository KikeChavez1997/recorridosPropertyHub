...
<table class="table table-striped" id="clientes">
    ...
    <tbody>
      ...
      <tr>
        ...
        <td><td><a class="btn btn-secondary" target="_blank" href="{{ url('show/client/active/'.$cliente->id)}}">Generar Url</a></td></td>

        <td> <a class="btn btn-success" href="{{ url('admin/show/cita/'.$cliente->id)}}">Agendar recorrido</a></td>
  ...
  <a class="btn btn-info"href="{{ route('asesorCalendar', ['id' => auth()->user()->id, 'name' => auth()->user()->name]) }}">Ver calendario</a>
    <br> <br>
    ...
    <table class="table table-striped" id="clientes">
        ...
        <tbody>
          ...
          <tr>
            ...
            <td><a class="btn btn-secondary" target="_blank" href="{{ url('show/client/active/'.$cliente->id)}}">Generar Url</a></td>
